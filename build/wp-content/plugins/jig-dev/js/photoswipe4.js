		...
		*/
        ...
        var _historyUpdateTimeout,
            ...
            _parseItemIndexFromURL = function () {
                ...
                hash = hash.replace(/([^|])(poster=|videoplayer)/gm, '$1|$2');
        ...
        var _onControlsTap = function (e) {
            ...
            _updateShareURLs = function () {
                ...
                if (typeof pswp.options.socialButtons !== 'undefined') {
                    ...
                    if (typeof pswp.options.shareButtons[3] !== 'undefined') {
                        shareButtons.push(pswp.options.shareButtons[3]);
                    }
                }
                ...
                jQuery.each(shareButtons, function (i, shareButtonData) {
                    if (typeof shareButtonData !== 'undefined') {
                        description =
                            (pswp.currItem.title || '') +
                                (pswp.currItem.description
                                    ? (pswp.currItem.title ? ' ' : '') + pswp.currItem.description
                                    : '') || document.title;
                        shareURL = shareButtonData.url
                            .replace('{{url}}', encodeURIComponent(URI))
                            .replace(
                                '{{facebook_url}}',
                                encodeURIComponent(
                                    URI.replace('#!', (URI.indexOf('?') === -1 ? '?' : '&') + '_escaped_fragment_=')
                                )
                            )
...
(function ($) {
    $.fn.JIGphotoSwipe = function (o) {
        ...
        var init = function () {
            if ($('.pswp').length === 0) {
                var captionClass =
                    typeof o.captionAlign !== 'undefined' ? ' pswp__ca_' + o.captionAlign : ' pswp__ca_center';
                $('body').append(
                    '<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true"><div class="pswp__bg"></div><div class="pswp__scroll-wrap"><div class="pswp__container"><div class="pswp__item"></div><div class="pswp__item"></div><div class="pswp__item"></div></div><div class="pswp__ui pswp__ui--hidden' +
                        captionClass +
        ...
        var parseThumbnailElements = function (rel) {
            ...
            elements.filter('[rel~="' + rel + '"]').each(function (index) {
                var el = $(this),
                    ...
                    contentIDbearerClass =
                        el.parent().attr('class') == 'jig-overflow'
                            ? el.closest('.jig-imageContainer').attr('class')
                            : el.attr('class'),
        ...
        var openPhotoSwipe = function (contentID, rel, disableAnimation) {
            ...
            o.shareButtons = [
                {
                    id: 'facebook',
                    label: 'Share on Facebook',
                    url: 'https://www.facebook.com/sharer/sharer.php?u={{facebook_url}}',
                },
                {id: 'twitter', label: 'Tweet', url: 'https://twitter.com/intent/tweet?text={{title}}&url={{url}}'},
                {
                    ...
                    label: 'Pin it',
                    url:
                        'http://www.pinterest.com/pin/create/button/?url={{url}}&media={{image_url}}&description={{description}}',
                },
            ];
            ...
            if (disableAnimation) {
                ...
                o.showAnimationDuration =
                    typeof origOptions.showAnimationDuration == 'undefined' ? 333 : origOptions.showAnimationDuration; // Put it back
            }
            ...
            if (element.parent().attr('class') == 'jig-overflow') {
                if (
                    element.find('img').css('margin-left') !== '0px' ||
                    element.parent().parent().hasClass('differentAspectRatio')
                ) {
                    cropped = true;
                }
            }
            ...
            if (cropped || (typeof o.aspectRatioMismatch !== 'undefined' && o.aspectRatioMismatch === true)) {
                o.showAnimationDuration = 0;
                o.showHideOpacity =
                    typeof origOptions.showHideOpacity == 'undefined' ? true : origOptions.showHideOpacity;
                o.mainClass = 'hidePsPlaceholder';
            } else {
                o.showAnimationDuration =
                    typeof origOptions.showAnimationDuration == 'undefined' ? 333 : origOptions.showAnimationDuration;
                o.showHideOpacity =
                    typeof origOptions.showHideOpacity == 'undefined' ? false : origOptions.showHideOpacity;
            ...
            if (putBackScroll == true) {
                ...
                setTimeout(function () {
                    $.fn.JIGphotoSwipe.gallery.options.closeOnScroll = true;
                }, 2000);
            }
        };
